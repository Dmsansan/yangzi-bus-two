...
<body class="easyui-layout">
    <div class="u-content">
            ...
            <table style="width: 100%;height:30%;padding-right: 28px;padding-left: 24px;">
                <tr>
                    ...
                    <td>
                       ...
                       <input id="up_company_name" class="easyui-textbox" style="width: 150px;" required="true" />
                    </td>
                    <td>
                        备注：
                    </td>
		...
		<div style="background-color: #ffffff;height:140px;margin:10px;">   
            ...
            <table id="aa" style="width: 100%;height:30%;padding-right: 28px;padding-left: 24px;">
                <tr>
                    ...
                    <td>
                        <input id="company_name" class="easyui-textbox" style="width: 150px;" required="true" />
                    </td>
                    <td>
                        备注：
                    </td>
        ...
        <div style="background-color: #ffffff;height:121px;margin:1px;">
            ...
            <span style="font-size:14px;color:#333333;font-weight: bold;display: inline-block;height: 78px;line-height: 78px;">分公司删除无法恢复，确定删除？</span>
        <div  style="width:100%;">
