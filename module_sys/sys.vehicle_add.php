...
<head>
    ...
    <script type="text/javascript">
        ...
        function f_save() {
            if ($(form1).valid()) {
				...
				if(comparam!="" && comparam!=null) {
					sendtxt="&cmd=edit&v_term_id=" + comparam;
				}
        ...
        function loadForm(oaid) {
            ...
            $.ajax({
                type: "GET",
                url: "../ajaction/v1/?menuid=101115&cmd=qrybyone", 
                data: { v_term_id: oaid, rnd: Math.random() }, 
                ...
                success: function (result) {
					...
					$("#v_term_no").val(obj.v_term_no);
					$("#v_term_name").val(obj.v_term_name);
...
<body>
    <form id="form1" onsubmit="return false">
        <table style="width: 600px; margin: 5px;" class='bodytable1'>
            ...
            <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">终端代码：</div>
                </td>
                <td>
                    <input type="text" id="v_term_no" name="v_term_no" ltype="text" ligerui="{width:196}" validate="{required:true}" /></td>
				<td>
			...
			<tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">终端名称：</div>
                </td>
                <td>
                    <input type="text" id="v_term_name" name="v_term_name" ltype="text" ligerui="{width:196}" validate="{required:true}" /></td>
				<!--<td>
                    <div style="width: 80px; text-align: right; float: right">车牌号码：</div>
                </td>
                <td>
					
                    <input type="text" id="plate_no"  name="plate_no" ltype="text" ligerui="{width:196}" validate="{required:true}" /></td> 
				-->
			</tr>
